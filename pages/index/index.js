...
Page({
  ...
  onLoad: function () {
    var app = getApp();
    var storeNearKeeperInfo = app.globalData.storeNearKeeper;
    console.log(storeNearKeeperInfo,'storeNearKeeperInfo')
    this.setData({
      storeNearKeeperInfo: storeNearKeeperInfo || {
  ...
  getProductList(e){
    ...
    wx.navigateTo({
      ...
      url: "/pages/indexMainStore/index"
    })
  } ,
  getleft(e){
    //slideLeft动态变化
  ...
  getMemberList(){
    wx.navigateTo({
      // url: "/pages/product_list/index?id=" + _id
      url: "/pages/indexMemberStore/index"
    })
  }
})
